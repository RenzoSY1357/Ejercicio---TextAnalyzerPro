 ...
 */
export function AnalizarTexto(text) {
    return {
 ...
 */
function ContarCaracteresSinSpacio(text) {
 ...
 */
function LongitudMediaPalabras(text) {
 ...
 */
function NumeroMedioPalabrasOracion(text) {
    // Oraciones
 ...
 */
function FrecuenciaPalabras(text) {
