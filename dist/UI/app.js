 ...
 */
function actualizarEstadisticas(text) {
    ...
    const PalabrasClave = document.querySelector("#PalabrasClave"); //necesita esto de HTML..., para que reconozca que es un ol
    PalabrasClave.innerHTML = ""; // Restea la lista
    const ArrayPalabras = Array.from(resultado.wordFrequency);
